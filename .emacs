...
(require 'compile)
(add-to-list 'compilation-error-regexp-alist '("^File \\(.+\\), line \\([0-9]+\\), characters \\([0-9]+\\)-\\([0-9]+\\):" 1 2 (3 . 4)))
(add-to-list 'compilation-error-regexp-alist '("^\\[l:\\([0-9]+\\);c:\\([0-9]+\\)\\].*\\[KO\\]" nil 1 2))
...
(custom-set-variables
 ...
 '(coq-load-path (quote ("~/.opam/system/lib/coq/theories" "~/git/focalize.git/zenon/")))
 '(coq-prog-name "/home/cauderlier/.opam/system/bin/coqtop")
 ...
 '(gnus-startup-file "/cauderlier@zamok.crans.org:.newsrc")
